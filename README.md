# The AirBnB Clone Project 
 Website Link [https://www.airbnb.co.za/?locale=en&_set_bev_on_new_domain=1678321093_MWRlYzQ5OWZlMzJi]
...
This command line interpreter  serves as the frontend of the web app where users can interact with the backend,
 which was developed with python OOP programming.
...
## How to start it
These instructions will get you a copy of the project up and running on your local machine (Ubuntu 20.04) for development and testing purposes.

## Installing

You will need to clone the an empty repository of your created project from Github. This will contain the simple shell program and all of its dependencies.
